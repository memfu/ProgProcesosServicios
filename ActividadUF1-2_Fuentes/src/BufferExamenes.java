...
public class BufferExamenes {
    ...
    public synchronized String consumirExamen() {
        /*
        Este método se encargará de suministrar un examen a cada hilo de tipo Examinador que lo solicite.
        Para suministrar el examen habrá antes que esperar hasta que haya algún examen para consumir en la cola.

        Haz aquí una pausa hasta que se haya fabricado algún examen.
        Si la cola sigue sin estar vacía, saca un examen y entrégalo como retorno de esta función.
         */
        return "";
    }
